            ...
            <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8'>
                <div className='md:w-11/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-12'>
                    <div className='lg:w-[40rem]'>
                        <img src={aboutImg} alt="" className='lg:w-[25rem]' />
                    </div>
                    <div className='md:w-3/5 mx-auto'>
                        <h2 className='text-4xl text-neutralDgrey font-semibold mb-4 md:w-4/5'>The unseen of spending three years at ......</h2>
                    ...
                    <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-12'>
                        <div className='space-y-8'>
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/logo/members.png" alt="" />
                                <div>
                            ...
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/logo/Event Bookings.png" alt="" />
                                <div>
                        ...
                        <div className='space-y-8'>
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/logo/clubs1.png" alt="" />
                                <div>
                            ...
                            <div className='flex items-center gap-4'>
                                <img src="/src/assets/logo/Payment.png" alt="" />
                                <div>
